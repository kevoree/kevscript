...
//        analyzeDirectory("phase1/native_function/return_array");
//    }
//
//    @Test
...
//        return this.interpretPhase1(expression, null);
//    }
//
//    private String interpretPhase1(final String basePath, String expression) {
//        final Commands cmds = new KevscriptInterpreter().interpret(expression, new KevscriptVisitor(new RootContext(basePath)));
//        String ret = "";
